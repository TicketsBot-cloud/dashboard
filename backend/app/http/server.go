...
import (
	...
	"github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api"
	admin_affiliate "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/admin/affiliate"
	admin_analytics_api "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/admin/analytics"
	"github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/admin/botstaff"
	admin_entitlements "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/admin/entitlements"
	admin_featureflags "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/admin/featureflags"
	admin_gallery "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/admin/gallery"
	admin_globalblacklist "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/admin/globalblacklist"
	admin_integrations "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/admin/integrations"
	admin_polarproducts "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/admin/polarproducts"
	...
	api_audit "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/auditlog"
	api_blacklist "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/blacklist"
	api_forms "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/forms"
	api_gallery "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/gallery"
	api_integrations "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/integrations"
	api_kb "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/kb"
	api_onboarding "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/onboarding"
	api_overview "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/overview"
	api_panels "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/panel"
	api_polar "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/polar"
	api_premium "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/premium"
	api_settings "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/settings"
	api_override "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/staffoverride"
	api_tags "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/tags"
	api_team "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/team"
	api_ticket "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/ticket"
	"github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/ticket/livechat"
	api_transcripts "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/transcripts"
	api_user "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/user"
	api_whitelabel "github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/api/whitelabel"
	"github.com/ticketsbot-cloud/dashboard/backend/app/http/endpoints/root"
	"github.com/ticketsbot-cloud/dashboard/backend/app/http/middleware"
