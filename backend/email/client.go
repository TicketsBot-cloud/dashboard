...
func (c *Client) SendNotification(ctx context.Context, to, subject, htmlBody, textBody, unsubscribeUrl string) error {
	if c == nil || c.mg == nil {
		return nil
	}

	msg := mailgun.NewMessage(c.from, subject, textBody, to)
