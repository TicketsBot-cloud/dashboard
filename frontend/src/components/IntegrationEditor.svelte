              ...
              <div>
                ...
                <div class="section">
                  <p>You can specify a URL to send a POST request to when a user adds your integration to their server /
                    ...
                    them. You can read more about secret validation in our <a class="link-blue" href="https://docs.tickets.bot/integrations/building-integrations#secret-validation">documentation</a>.</p>
