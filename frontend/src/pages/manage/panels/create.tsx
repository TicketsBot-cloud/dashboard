...
const PanelsPage: FC = () => {
  ...
  const [panel, setPanel] = useState<Panel>({
    ...
    message_uses_components_v2: false,
    message_components: null,
    welcome_message_uses_components_v2: false,
    welcome_message_components: null,
    access_control_list: [
      {
        action: "allow",
        role_id: guildId,
    ...
    const fetchSourcePanel = async () => {
      ...
      try {
        ...
        setPanel({
          ...
          name: source.name ? `${source.name} (Copy)`.slice(0, 80) : null,
        });
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        onClick={() => {
          if (!panel.name?.trim()) {
            toast.error("Enter a panel name before creating the panel.");
            return;
          }
